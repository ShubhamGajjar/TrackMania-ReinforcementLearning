...
tmi_dir = Path("C:\\Users\\Implici7\\Documents\\Project\\TMInterface\\Scripts")

run_dir = base_dir / "save" / "7" / "best_runs"
...
run_to_video.make_widget_video_from_q_values_on_disk(
    q_values_path=run_dir / "153245" / "q_values.joblib", video_path=base_dir / "153245.mov", q_value_gap=0.03
)
